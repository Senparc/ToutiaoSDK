...
/*----------------------------------------------------------------
    ...
    文件功能描述：头条容器接口中的封装Value（如Ticket、AccessToken等数据集合）
...
namespace Senparc.Toutiao.Containers
{
    /// <summary>
...
//#endif
        ...
        //                containerBag.CacheTime = DateTimeOffset.Now;//记录缓存时间

        //                //cacheKey形如:Container:Senparc.Toutiao.MP.Containers.AccessTokenBag:wx669ef95216eef885
